...
static const flex_int16_t yy_nxt[17] =
    {   0,
        4,    5,    6,    4,    8,    8,   10,   10,    9,   11,
        7,    3,   11,   11,   11,   11
    } ;

static const flex_int16_t yy_chk[17] =
    {   0,
        1,    1,    1,    1,   12,   12,   14,   14,   13,    3,
        2,   11,   11,   11,   11,   11
    } ;
...
YY_RULE_SETUP
#line 10 "q4.l"
{printf("Zero Number : %s",yytext);zero++;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 11 "q4.l"
{printf("Positive Number : %s",yytext);pos++;}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 12 "q4.l"
{printf("Negative Number : %s",yytext);neg++;}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 14 "q4.l"
